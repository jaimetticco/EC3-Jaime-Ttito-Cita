package com.admin.ec3jaimettitocita.controller;


import com.admin.ec3jaimettitocita.model.UsuarioCliente;
import com.admin.ec3jaimettitocita.service.UsuarioClienteService;
...
public class UsuarioClienteController {
    ...
    public ResponseEntity<?> borrar(@PathVariable Integer id_usuario) {
        ...
        if(uc != null) {
            ...
            response.put("mensaje", "UsuarioCliente '" .concat(uc.getUsuario()).concat("' eliminado con éxito!"));
    ...
    public ResponseEntity<?> editar(@RequestBody UsuarioCliente usuarioCliente) {
        ...
        if(uc != null) {
            ...
            response.put("mensaje", "UsuarioCliente " + usuarioCliente.getUsuario() + " actualizado con éxito");
            return new ResponseEntity<Map<String, Object>>(response, HttpStatus.CREATED);
        }
        return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
    }
